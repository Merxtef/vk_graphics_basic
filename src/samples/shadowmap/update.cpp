...
void SimpleShadowmapRender::UpdateUniformBuffer(float a_time)
{
  ...
  m_uniforms.lightPos = spotlightPos;
  m_uniforms.time        = a_time;

  m_uniforms.spotlightInnerCos = cos(spotlightInnerAngle * M_PI / 180.f);
  m_uniforms.spotlightOuterCos = cos(spotlightOuterAngle * M_PI / 180.f);
  m_uniforms.spotlightDir = spotlightLookAt - m_uniforms.lightPos;
